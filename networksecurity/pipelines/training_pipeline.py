...
class TrainingPipeline:
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            logging.info(f"Data validation completed and data validation artifact: {data_validation_artifact}")
    ...
    def start_data_transfromation(self,data_validation_artifact:DataValidationArtifact):
        ...
        try:
            ...
            logging.info(f"Data transformation completed and data transformation artifact: {data_transformation_artifact}")
