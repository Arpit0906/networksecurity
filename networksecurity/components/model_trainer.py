...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        ...
        self.track_mlflow(best_model=best_model,classification_metrics=classification_train_metric)

        y_test_pred=best_model.predict(x_test)
        classification_test_metric=get_classification_score(y_true=y_test,y_pred=y_test_pred)
        self.track_mlflow(best_model=best_model,classification_metrics=classification_test_metric)
