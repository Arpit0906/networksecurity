...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered the initiate data transformation method of Data Transformation class.")
        try:
            ...
            ## Applying preprocessor ont the dataset 
